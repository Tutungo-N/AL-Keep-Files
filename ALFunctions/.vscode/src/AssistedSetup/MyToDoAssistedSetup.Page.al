page 50145 MyToDoAssistedSetup
{
    PageType = NavigatePage;
    SourceTable = "To-do";
    SourceTableTemporary = true;
    Caption = 'Add Something for the Team to Actualize';
    UsageCategory = Tasks;
    ...
    layout
    {
        area(Content)
        {
            group(Step1)
            {
                ...
                group("Welcome")
                {
                    Caption = 'Welcome to my to-do assisted setup';
                    group(group11)
                    {
                        Caption = '';
                        InstructionalText = 'Use this guide to register a to-do task for your team.';
                    }
                }
                group("Let's Go")
                {
                    ...
                    {
                        Caption = '';
                        InstructionalText = 'Select Next to proceed';
                    }
                }
            ...
            group(Step2)
            {
                ...
                group("11")
                {
                    Caption = 'Add attendees and fill in the details';
            ...
            {
                Caption = 'That''s All';
                InstructionalText = 'Select Finish to Save';
    ...
    var
        ...
        MyToDoRec: Record "To-do";
        TopBannerVisible, FinishActionEnabled : Boolean;
    ...
    begin
        MyToDoRec.TransferFields(Rec, true);
        MyToDoRec.Insert();
    end;
