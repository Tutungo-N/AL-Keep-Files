table 50000 "Member Application"
{
    ...
    var
        //MemberManager: Codeunit "Member Management";
    ...
    begin
        //MemberManager.Run();
        if "Member Application No." = '' then begin
            GeneralSetup.Get();
            GeneralSetup.TestField("Member Nos");
            "Member Application No." := NoSeriesManagement.GetNextNo(GeneralSetup."Member Nos", Today, True);

        end;
        /* if "Full Name" = "Full Name" then begin
             VALIDATE("Full Name", "First Name" + ' ' + "Second Name" + ' ' + "Last Name");
         end;*/
    end;
